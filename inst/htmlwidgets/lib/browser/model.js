...
(function () {
  ...
  DataSet = function DataSet(raw) {
    var assertSingleRoot, augmentAsTree, dataset, stratified;
    dataset = function dataset() {};
    // --- internals ------------------------------------------------------
    assertSingleRoot = function assertSingleRoot() {
      var roots;
      roots = raw.filter(function (artifact) {
        var ref;
        return !((ref = artifact.parents) != null ? ref.length : void 0);
      });
      if (roots.length) {
        roots.forEach(function (artifact) {
